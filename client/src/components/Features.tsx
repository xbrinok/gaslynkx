      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="feature-card bg-gray-50 rounded-xl p-8 shadow-md hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-semibold mb-4 text-center md:text-left">{feature.title}</h3>
